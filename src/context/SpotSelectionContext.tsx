...
const SpotSelectionContext = createContext<SpotSelectionContextValue | undefined>(
  undefined,
);
...
export function useSpotSelection() {
  ...
  if (!context) {
    throw new Error("useSpotSelection must be used within SpotSelectionProvider");
  }
  return context;
}
